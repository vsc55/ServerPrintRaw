...
echo.	
echo INICIANDO PROCESO DE INSTALACION DEL SERVICIO...
echo.
echo AVISO: EL FORMATO CORRECTO DEL NOMBRE DE USUARIO SERIA EL SIGUIENTE: .\usuario
echo.
echo.
pause
!INSTALLUTILDIR!\installutil.exe ServerPrintRawService.exe
